          ...
          <List className={classes.list}>
            {isSignedInUser && (
              <React.Fragment>
                ...
                <ListItem className={classes.inlineBlock}>
                  <a href="/create-exercise" className={classes.block}>
                    New Exercise
                  </a>
                </ListItem>
                <ListItem className={classes.inlineBlock}>
                  <a href="/edit-exercises" className={classes.block}>
                    Edit Exercises
                  </a>
                </ListItem>
                <ListItem className={classes.inlineBlock}>
                  <a href="/create-workout" className={classes.block}>
                    New Workout
                  </a>
                </ListItem>
                <ListItem className={classes.inlineBlock}>
                  <a href="/edit-workout" className={classes.block}>
                    Edit Workout
                  </a>
                </ListItem>
              </React.Fragment>
